...
public class JdbcSinkConnectorTask extends SinkTask {
    ...
    public void start(Map<String, String> props) {
        ...
        try {
            ...
            TaskStateInDBManager taskStateInDBManager = new TaskStateInDBManager(session, props.get("ddl.tablelist"), props.get("ddl.dmltasks.num"));
            RecordWriter recordWriter = new RecordWriter(session, queryBinderResolver, config, databaseDialect, taskStateInDBManager);

            changeEventSink = new JdbcChangeEventSink(config, session, databaseDialect, recordWriter, taskStateInDBManager, props.get("ddl.dmltasks.uri"));
        }
        finally {
            stateLock.unlock();
        }
    ...
    public void put(Collection<SinkRecord> records) {
        ...
        System.out.println(context.toString().replaceAll("\\D+", ""));
