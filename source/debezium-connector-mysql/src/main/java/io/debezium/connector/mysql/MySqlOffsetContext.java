...
public class MySqlOffsetContext extends CommonOffsetContext<SourceInfo> {
    ...
    //TableName: DDLVersion을 찾기위한 key 값으로 사용, {DBName.TableName}
    public String getTableInstance() {
        String tableInstance = sourceInfo.table();
        //pt-osc 고려
        if (tableInstance != null && tableInstance.startsWith("_") && (tableInstance.endsWith("_new") || tableInstance.endsWith("_old"))) {
