...
public class HistoryRecord {
    ...
    public HistoryRecord(Map<String, ?> source, Map<String, ?> position, String databaseName, String schemaName,
        ...
        if (ddlVersion != null) {
            DDLVersionInfo ddlVersionLogger = DDLVersionInfo.getInstance();
            ddlVersionLogger.updateDDLVersion(ddlVersion);
            doc.setString(Fields.DDL_VERSION, ddlVersion);
        }
    ...
    protected String ddlVersion() {
        return doc.getString(Fields.DDL_VERSION);
    }
