...
public abstract class RelationalChangeRecordEmitter<P extends Partition>
    ...
    protected void emitCreateRecord(Receiver<P> receiver, TableSchema tableSchema)
        ...
        Struct envelope = tableSchema.getEnvelopeSchema().create(newValue, getOffset().getSourceInfo(), getClock().currentTimeAsInstant(), getDdlVersion());
    ...
    protected void emitReadRecord(Receiver<P> receiver, TableSchema tableSchema)
        ...
        Struct newKey = tableSchema.keyFromColumnData(newColumnValues);
        Struct newValue = tableSchema.valueFromColumnData(newColumnValues);
        Struct envelope = tableSchema.getEnvelopeSchema().read(newValue, getOffset().getSourceInfo(), getClock().currentTimeAsInstant(), getDdlVersion());
    ...
    protected void emitUpdateRecord(Receiver<P> receiver, TableSchema tableSchema)
        ...
        if (oldKey == null || Objects.equals(oldKey, newKey)) {
            Struct envelope = tableSchema.getEnvelopeSchema().update(oldValue, newValue, getOffset().getSourceInfo(), getClock().currentTimeAsInstant(), getDdlVersion());
    ...
    protected void emitDeleteRecord(Receiver<P> receiver, TableSchema tableSchema) throws InterruptedException {
        ...
        Struct envelope = tableSchema.getEnvelopeSchema().delete(oldValue, getOffset().getSourceInfo(), getClock().currentTimeAsInstant(), getDdlVersion());
    ...
    protected abstract String getDdlVersion();
    ...
    protected void emitUpdateAsPrimaryKeyChangeRecord(Receiver<P> receiver, TableSchema tableSchema, Struct oldKey,
        ...
        envelope = tableSchema.getEnvelopeSchema().create(newValue, getOffset().getSourceInfo(), getClock().currentTimeAsInstant(), getDdlVersion());
